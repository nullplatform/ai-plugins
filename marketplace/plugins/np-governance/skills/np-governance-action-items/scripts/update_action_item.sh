#!/bin/bash
#
# update_action_item.sh - Patch an action item's data fields
#
# Usage:
...
#   --config <json>
#
# This endpoint updates data fields only. Status transitions are performed with
# the dedicated action scripts: defer / resolve / reject / close / reopen.
...
ID=""
TITLE=""; DESCRIPTION=""; PRIORITY=""; VALUE=""; DUE_DATE=""
